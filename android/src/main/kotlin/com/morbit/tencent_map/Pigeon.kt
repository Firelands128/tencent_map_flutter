...
//          channel.setMessageHandler { message, reply ->
//            val args = message as List<Any?>
//            val positionArg = args[0] as UIControlPosition
//            var wrapped: List<Any?>
//            try {
//              api.setLogoPosition(positionArg)
//              wrapped = listOf<Any?>(null)
//            } catch (exception: Throwable) {
//              wrapped = wrapError(exception)
//            }
...
//            var wrapped: List<Any?>
//            try {
//              api.setScalePosition(positionArg)
//              wrapped = listOf<Any?>(null)
//            } catch (exception: Throwable) {
//              wrapped = wrapError(exception)
//            }
...
//  fun onScaleViewChanged(scaleArg: Double, callback: () -> Unit) {
