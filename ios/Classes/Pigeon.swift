...
//  /// 设置LOGO的位置
//  func setLogoPosition(position: UIControlPosition) throws
//  /// 设置比例尺的位置（iOS不支持改变位置锚点，仅支持改变位置偏移）
//  func setScalePosition(position: UIControlPosition) throws
//  /// 设置指南针的位置偏移
...
//        let args = message as! [Any?]
//        let positionArg = args[0] as! UIControlPosition
//        do {
//          try api.setLogoPosition(position: positionArg)
//          reply(wrapResult(nil))
//        } catch {
//          reply(wrapError(error))
//        }
...
//        let positionArg = args[0] as! UIControlPosition
//        do {
//          try api.setScalePosition(position: positionArg)
//          reply(wrapResult(nil))
//        } catch {
//          reply(wrapError(error))
//        }
...
//  func onScaleViewChanged(scale scaleArg: Double, completion: @escaping () -> Void) {
...
//    channel.sendMessage([scaleArg] as [Any?]) { _ in
//      completion()
//    }
//  }
