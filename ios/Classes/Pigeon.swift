...
class TencentMapSdkApiSetup {
  ...
  static func setUp(_ binaryMessenger: FlutterBinaryMessenger, _ api: TencentMapSdkApi?) {
    let initSdkChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapSdkApi.initSdk", binaryMessenger: binaryMessenger)
    if let api = api {
...
class TencentMapApiSetup {
  ...
  static func setUp(_ binaryMessenger: FlutterBinaryMessenger, _ api: TencentMapApi?) {
    let setMapTypeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setMapType", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCompassEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setCompassEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setScaleControlsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setScaleControlsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setRotateGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setRotateGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setScrollGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setScrollGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setZoomGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setZoomGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTiltGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setTiltGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setIndoorViewEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setIndoorViewEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTrafficEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setTrafficEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setBuildingsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setBuildingsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMyLocationButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setMyLocationButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMyLocationEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setMyLocationEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMyLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setMyLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMyLocationStyleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.setMyLocationStyle", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.moveCamera", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addMarkerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.addMarker", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addPolylineChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.addPolyline", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let pauseChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.pause", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let resumeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.resume", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let stopChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.stop", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let startChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.start", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let destoryChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapApi.destory", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class TencentMapHandler {
  ...
  func onTap(latLng latLngArg: LatLng, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onTap", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([latLngArg] as [Any?]) { _ in
      completion()
    }
  }
  func onTapPoi(poi poiArg: MapPoi, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onTapPoi", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([poiArg] as [Any?]) { _ in
      completion()
    }
  }
  func onLongPress(latLng latLngArg: LatLng, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onLongPress", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([latLngArg] as [Any?]) { _ in
      completion()
    }
  }
  func onCameraMove(cameraPosition cameraPositionArg: CameraPosition, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onCameraMove", binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onCameraIdle(cameraPosition cameraPositionArg: CameraPosition, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onCameraIdle", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([cameraPositionArg] as [Any?]) { _ in
      completion()
    }
  }
  func onLocation(location locationArg: Location, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onLocation", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([locationArg] as [Any?]) { _ in
      completion()
    }
  }
  func onTapMarker(markerId markerIdArg: String, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onTapMarker", binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onMarkerDragStart(markerId markerIdArg: String, latLng latLngArg: LatLng, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onMarkerDragStart", binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onMarkerDrag(markerId markerIdArg: String, latLng latLngArg: LatLng, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onMarkerDrag", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([markerIdArg, latLngArg] as [Any?]) { _ in
      completion()
    }
  }
  func onMarkerDragEnd(markerId markerIdArg: String, latLng latLngArg: LatLng, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.TencentMapHandler.onMarkerDragEnd", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([markerIdArg, latLngArg] as [Any?]) { _ in
      completion()
    }
  }
...
class MarkerApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MarkerApi?) {
    let removeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.remove", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setRotationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.setRotation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setPositionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.setPosition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setAnchorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.setAnchor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setZIndexChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.setZIndex", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setAlphaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.setAlpha", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setIconChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.setIcon", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setDraggableChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.morbit.MarkerApi.setDraggable", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
