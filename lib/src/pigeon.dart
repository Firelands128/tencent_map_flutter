...
//
//   /// 设置LOGO的位置
//   void setLogoPosition(UIControlPosition position);
//
//   /// 设置比例尺的位置（iOS不支持改变位置锚点，仅支持改变位置偏移）
//   void setScalePosition(UIControlPosition position);
//
//   /// 设置指南针的位置偏移
...
//   void onScaleViewChanged(double scale);
//
...
//   /// UI控件位置锚点
//   late UIControlAnchor anchor;
//
//   /// UI控件位置偏移
//   late UIControlOffset offset;
// }
//
// /// UI控件位置偏移
